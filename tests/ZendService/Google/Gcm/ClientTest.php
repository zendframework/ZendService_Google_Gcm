...
class ClientTest extends \PHPUnit_Framework_TestCase {
	...
	public function testSetHttpSSLPathClient() {
		$client = new HttpClient ();
	...
	public function testSendResultInvalidRegistrationId() {
		$body = $this->_createJSONResponse ( 101, 0, 1, 0, array (
				array (
	...
	public function testSendResultSuccessful() {
		$body = $this->_createJSONResponse ( 101, 1, 0, 0, array (
				array (
						'message_id' => '1:2342' 
				) 
		) );
	...
	public function testSendResultSuccessfulWithRegistrationId() {
		$body = $this->_createJSONResponse ( 101, 1, 0, 1, array (
				array (
						'message_id' => '1:2342',
						'registration_id' => 'testfoo' 
				) 
		) );
		$this->httpAdapter->setResponse ( 'HTTP/1.1 200 OK' . "\r\n" . 'Context-Type: text/html' . "\r\n\r\n" . $body );
		$response = $this->gcmClient->send ( $this->message );
